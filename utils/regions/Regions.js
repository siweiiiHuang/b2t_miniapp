...
class Regions {
    ...
    openRegionsModal(e) {
        ...
        if (e.currentTarget.dataset.fid && e.currentTarget.dataset.idx){
            this.fromRegionsData = {
    ...
    endCall(parentId, name) {
        ...
        if (this.options.setFromRegionsVal && typeof this.options.setFromRegionsVal == 'function') {
            this.options.setFromRegionsVal(this.fromRegionsData, this.address);
        }
    }
}
