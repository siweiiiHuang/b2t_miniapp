...
Page({
    ...
    payNow: function(e){
        ...
        var found_id = order.team_follow ? order.team_follow.found_id : 0;
        wx.navigateTo({
            url: '/pages/team/team_confirm/team_confirm?orderSn=' + order.order_sn + '&orderPay=true' + '&found_id=' + found_id
        })
    },
